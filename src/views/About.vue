  ...
  <div class="about-us-container">
    ...
    <div class="about-us-team">
      ...
      <div class="supervisor-section">
        <div class="founder-card supervisor-card">
          <div class="founder-info">
            <h3>Salih Abu Shahin</h3>
            <p class="founder-title">Project Supervisor</p>
          </div>
        </div>
      </div>
    </div>
...
.about-project h1 {
  font-size: 2.5rem;
  font-weight: 700;
  background-image: linear-gradient(to right, #719920, #9bd74b);
...
.founder-card {
  ...
  border-radius: 20px;
  overflow: hidden;
  box-shadow: 0 10px 20px rgba(113, 153, 32, 0.15);
...
.founder-card:hover {
  ...
  box-shadow: 0 15px 30px rgba(113, 153, 32, 0.25);
}
...
.supervisor-card {
  background: linear-gradient(to right, #f8fbf4, #eef6e2);
  border: 2px solid #c6d8a5;
}
...
/* Corrected Tech Carousel Styles */
.tech-carousel {
  /* Removed fixed width, now it will fit its container */
  max-width: 100vw;
  overflow: hidden;
...
/* Corrected animation to use a seamless loop with duplicated items */
@keyframes scroll {
  0% {
    transform: translateX(0);
  }
  100% {
    transform: translateX(-50%); /* This percentage is for duplicated items */
  }
}
